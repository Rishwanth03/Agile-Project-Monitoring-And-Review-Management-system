...
exports.getOverviewAnalytics = exports.getStudentAnalytics = void 0;
...
const getOverviewAnalytics = async (req, res) => {
    try {
        ...
        const allSubmissions = teams.flatMap((t) => t.sprints.flatMap((s) => s.submissions));
        ...
        // Sprint-wise data
        const sprintData = teams.flatMap((t) => t.sprints.map((s) => {
