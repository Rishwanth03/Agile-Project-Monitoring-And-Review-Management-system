...
exports.getHistory = exports.getSubmissions = exports.submitSprint = exports.getStudentDashboard = void 0;
const database_1 = __importDefault(require("../config/database"));
const getStudentDashboard = async (req, res) => {
    try {
        const userId = req.user.userId;
        // Get teams the student belongs to
        const teamMemberships = await database_1.default.teamMember.findMany({
        ...
        const currentSprint = teamMemberships.length > 0
            ...
            : null;
        // Recent feedback
        const recentFeedback = await database_1.default.review.findMany({
            where: {
...
const submitSprint = async (req, res) => {
    try {
        ...
        const existingSubmission = await database_1.default.submission.findFirst({
...
exports.submitSprint = submitSprint;
